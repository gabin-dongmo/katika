# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2026-01-24 05:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_inaccurate', models.NullBooleanField(blank=True, null=True)),
                ...
                ('type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='incident.IncidentType')),
            ],
            options={
